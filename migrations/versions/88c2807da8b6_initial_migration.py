...
Revision ID: 88c2807da8b6
Revises: 
Create Date: 2019-08-07 13:17:43.895374
...
def upgrade():
    ...
    sa.Column('toppings', sa.String(length=200), nullable=True),
    sa.Column('crust', sa.String(length=200), nullable=True),
